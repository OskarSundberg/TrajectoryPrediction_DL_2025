...
class TrajectoryDataset(Dataset):
    ...
    def __init__(self, data, df_vector=None, env_df=None, dataset_len=None, max_num_agents=30, src_length=10, tgt_length=40, info=False):
        """
    ...
    #             # Get all agsrcents at the current timestamp
    ...
    #         'src': src,
    #         'tgt': tgt,
    #         'dist': distances,          # based on enviroment data
    #         'dist_type': agent_types,   # based on enviroment data
    #         'timestamp': timestamps
    #     }
    #     return sample